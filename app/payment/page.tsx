        ...
        <main>
            ...
            <section className="payment">
                        <div className="payment-text">
                            <h2>Avoid <b>Failed Transfers</b><br /> & Hidden <b>Fees</b></h2>
                            <span>Pay Suppliers the Easy Way.”</span>
                            <p>Paying suppliers in China can be stressful<br /> and expensive. We make it effortless.<br /> Simply pay in Naira through local transfer,<br /> and we handle supplier payments instantly<br /> in RMB—securely and transparently. No<br /> hidden charges, no FX confusion, no<br /> payment delays.</p>
                        </div>
            
                        <img src="/images/payment.png" />
                    </section>
            
                    <section className="payment-form" id="form1">
